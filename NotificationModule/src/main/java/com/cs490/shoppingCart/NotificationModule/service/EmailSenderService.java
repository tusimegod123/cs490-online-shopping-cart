...
//        AddressDTO address= user!=null? user.getUserAddress():null;
        ...
        if(transaction != null){
            ...
            if(transaction.getTransactionType().equalsIgnoreCase("OrderPayment")){
                ...
                body.append("<tr><td>"+transaction.getOrderId()+"</td><td>   </td><td>"+transaction.getTransactionValue()+"</td></tr>");
                ...
                body.append("<tr><td>"+address.getStreet()+"<br>"+address.getCity()+", "+ address.getState()+
                        "<br>"+address.getCountry()+"<br>"+address.getZipcode()+"</td><td>      </td><td>"+ transaction.getTransactionDate()+"</td></tr>");
